export const en = {
    app: {
        title: "SYSTEM HARDENING PROTOCOL",
        version: "v8.3.1",
    ...
    override: {
        mission: "MISSION: UNFINISHED BUSINESS",
        exit: "EXIT (ESC)"
    },
    dashboard: {
        ...
        gainer_ingredients: "Milk + Oats + PB + Banana",
        injected: "INJECTED",
    ...
    training: {
        ...
        enter_set_rep: "Enter Set / Reps",
        weight_kg: "Weight (kg)",
        time_sec: "Time (sec)",
        weighted_set: "Weighted Set",
        timed_set: "Timed Set",
    ...
    sleep: {
        ...
        sleep_hours_placeholder: "Sleep hours...",
        save_data: "SAVE DATA",
    ...
    db: {
        weekly_plan: {
            ...
            "3": { name: "WEDNESDAY", title: "CORE & KERNEL" },
            "4": { name: "THURSDAY", title: "LEG DAY" },
            "5": { name: "FRIDAY", title: "STRESS TEST" },
            "6": { name: "SATURDAY", title: "ACTIVE REST" },
            "0": { name: "SUNDAY", title: "SYSTEM REBOOT" }
        },
        foods: {
            breakfast: {
        ...
        anatomy: {
            ...
            quads: { name: "Quadriceps", function: "Body carrying, piston power.", system: "Locomotor", action: "Squat", recovery: "72 Hours" },
            biceps: { name: "Biceps Brachii", function: "Pulling, gripping.", system: "Upper Body Pull", action: "Hammer Curl", recovery: "48 Hours" },
            traps: { name: "Trapezius", function: "Shoulder stabilization.", system: "Posterior Chain", action: "Farmer's Walk", recovery: "48 Hours" },
            lats: { name: "Latissimus Dorsi", function: "Torso pull up.", system: "Posterior Chain", action: "One Arm Row", recovery: "48-72 Hours" },
            glutes: { name: "Gluteus Maximus", function: "Thrusting power.", system: "Power Center", action: "Squat", recovery: "72 Hours" },
            hamstrings: { name: "Hamstrings", function: "Knee bending.", system: "Locomotor", action: "Squat", recovery: "48-72 Hours" },
            lowerback: { name: "Erector Spinae", function: "Keeping spine upright.", system: "Core Support", action: "Superman", recovery: "48 Hours" },
            pelvic: { name: "Pelvic Floor", function: "Ejaculation control.", system: "Reproductive", action: "Kegel", recovery: "24 Hours" }
        }
    }
};
